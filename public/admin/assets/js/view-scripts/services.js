 ...
 * @param {array} datas - Array of service objects
 */
function populateTable(datas) {
    ...
    if (datas.length) {
        datas.forEach(function (data) {
            html += `
                ...
                30
                    ...
                    <td>${data.credit}</td>
                    <td><a class="change-status" href="service/${
                        data.id
                    ...
                    <td>
                        <div class="table-action">
                            <a data-bs-toggle="tooltip" title="Edit ${trimString(
                                data.name,
                                15
                            )}" class="cat-from-button" href="/admin/service/${
                data.id
        ...
        html = emptyTable(message = "No Service Available");    }
    tableBody.html(html);
    initializeCatForm();
    triggerChangeStatus();
}
